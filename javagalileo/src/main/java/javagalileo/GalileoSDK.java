...
public class GalileoSDK { // Save as HelloJNI.java
    ...
    private native GALILEO_RETURN_CODE Connect(long instance, byte[] targetID, Boolean auto_connect,
    int timeout, OnConnectEventListener onConnect, OnDisconnectEventListener onDisconnect);
    ...
    private native GALILEO_RETURN_CODE SetCurrentStatusCallback(long instance, OnStatusUpdateEventListener onStatusUpdate);
